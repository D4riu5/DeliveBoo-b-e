...
<body>
    <div id="app">
        ...
        <header class="barraLogo barraColor navbar navbar-dark sticky-top bg-dark flex-md-nowrap shadow">
        ...
        <div class="container-fluid" style="height: calc(100vh - 84px);">
            ...
            <div class="row h-100">
                ...
                <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4 p-2 d-flex flex-column overflow-auto"
