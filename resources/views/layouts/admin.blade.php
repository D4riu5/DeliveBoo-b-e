    ...
    <body>
        <div id="app">
            ...
            <header class="navbar navbar-dark sticky-top bg-dark flex-md-nowrap p-2 shadow">
                <a class="navbar-brand col-md-3 col-lg-2 me-0 text-center" href="{{ env('APP_FRONTEND_URL') }}">Tasty Taxi (provvisorio)</a>
                    ...
                    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-dark navbar-dark sidebar collapse">
                        <div class="py-3">
                            <ul class="nav flex-column">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link text-white {{ Route::currentRouteName() == 'admin.food.index' ? 'bg-secondary' : '' }}" href="{{route('admin.food.index')}}">
