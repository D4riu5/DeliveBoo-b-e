    ...
    public function run(Faker $faker)
    {
        ...
        $foods = [
            ...
            [
                ...
                'gluten_free' => false,
                'kcal' => 650,
                'restaurant_ids' => [3, 14, 37, 40, 42], //AMERICANA
            ],
            // PIATTO 54
            [
                ...
                'gluten_free' => false,
                'kcal' => 450,
                'restaurant_ids' => [3, 14, 37, 40], //AMERICANA
            ],
            // PIATTO 55
            [
                'name' => 'Mac and Cheese',
                ...
                'gluten_free' => false,
                'kcal' => 550,
                'restaurant_ids' => [3, 14, 40, 42], //AMERICANA
            ],
            // PIATTO 56
            [
                'name' => 'Jambalaya',
            ...
            [
                ...
                'gluten_free' => false,
                'kcal' => 400,
                'restaurant_ids' => [3, 14, 37, 38, 40], //AMERICANA
            ],
            // PIATTO 61
            [
                ...
                'gluten_free' => false,
                'kcal' => 200,
                'restaurant_ids' => [3, 14, 38, 40, 42], //AMERICANA
            ],
            // PIATTO 62
            [
                'name' => 'Coca-Cola',
                ...
                'gluten_free' => true,
                'kcal' => 140,
                'restaurant_ids' => [3, 14, 37, 39, 40], //AMERICANA
            ],
            // PIATTO 63
            [
                'name' => 'Iced Tea',
                ...
                'gluten_free' => true,
                'kcal' => 90,
                'restaurant_ids' => [3, 14, 37, 39, 40, 42] //AMERICANA
            ],
            ...
            [
                ...
                'gluten_free' => true,
                'kcal' => 400,
                'restaurant_ids' => [17, 18, 38, 42, 43], //COREANA
            ],
            // PIATTO 83
            [
                'name' => 'Hotteok',
